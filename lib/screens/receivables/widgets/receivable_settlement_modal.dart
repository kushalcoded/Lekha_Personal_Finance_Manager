...
Future<void> showReceivableSettlementModal(
  ...
  return showResponsiveSheet(
    context,
    maxWidth: 520,
    mobileChild: ReceivableSettlementForm(
      receivable: receivable,
      isDialog: false,
    ),
    desktopChild: ReceivableSettlementForm(
      receivable: receivable,
      isDialog: true,
    ),
  );
...
class _ReceivableSettlementFormState
  ...
  void initState() {
    super.initState();
    _amountController.text = widget.receivable.remaining.toStringAsFixed(2);
  }
  ...
  bool get _isAmountValid {
    ...
    return value != null && value > 0 && value <= widget.receivable.remaining;
  }
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${widget.receivable.fromPerson} owes ${AppFormatters.formatCurrency(widget.receivable.remaining)}',
